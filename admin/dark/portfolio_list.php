...
require_once "../settings/code/portfolio-add.php" ?>
                            ...
                            <div class="card my-4">
                                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                        <h6 class="text-white text-capitalize ps-3">Portfolio List</h6>
                                    </div>
                                </div>
                                    ...
                                    <div class="table-responsive p-0">
                                        <table class="table align-items-center mb-0">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0"><?= $port_list[$i]["title"]?></p>
                                                </td>
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0"><?= $port_list[$i]["description"]?></p>
                                                </td>
                                                <td>
                                                <p class="text-xs font-weight-bold mb-0"><?= $port_list[$i]["link"]?></p>
                                                </td>
